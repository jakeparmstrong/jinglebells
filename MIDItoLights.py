#Getting telemetry from Sonic Pi using MIDI
#Python is reading the note value as UTF-8?
#Look into python-osc bridger again...
#Then work on connecting it to light LED strip
